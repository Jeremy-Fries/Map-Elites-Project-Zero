...
void Map_Elites::place_individual_in_map(Individual Passed_I){
    ...
    //Passed_I.display_phenotype1();
    //Passed_I.display_phenotype2();
    ...
    cout << endl << "p1_lower is:"<< p1_lower << endl;
    cout << endl << "p2_lower is:"<< p2_lower << endl;
    cout << endl << "p1_upper is:"<< p1_upper << endl;
    cout << endl << "p2_upper is:"<< p2_upper << endl;
    ...
    cout << endl << "Starting pLB1 is:"<< pLB1 << endl;
    cout << endl << "Starting pLB2 is:"<< pLB2 << endl;
    ...
    for(int d1=0; d1<num_spacing1; d1++){                                       // TODO - table flipped wrong direction, check initilaize() as well.
        ...
        cout << endl << "pLB1 is:"<< pLB1 << endl;
        cout << endl << "pUB1 is:"<< pUB1 << endl;
    }
    ...
    for(int d2=0; d2<num_spacing2; d2++){
        ...
        cout << endl << "pLB2 is:"<< pLB2 << endl;
        cout << endl << "pUB2 is:"<< pUB2 << endl;
    }
